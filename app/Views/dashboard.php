    ...
    <div class="sidebar" id="side_nav">
      ...
      <ul class="list-unstyled px-2 pt-4">
        <li class="active my-3">
          <a href="#" class="text-decoration-none d-block px-3 py-2"><i class="fa-solid fa-house me-3"></i>Dashboard</a>
        </li>
        <li class="mb-3">
    ...
    <div class="content">
      <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
          <span class="navbrand navbar-brand mb-0 fs-5">Dashboard</span>
          <div><a href="#" class="text-decoration-none me-2">Logout <i class="fa-solid fa-right-from-bracket ms-1"></i></a></div>
        </div>
      </nav>
    </div>
  </div>
