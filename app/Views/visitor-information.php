    ...
    <div class="sidebar" id="side_nav">
      ...
      <ul class="list-unstyled px-2 pt-4">
        ...
        <li class="active mb-3">
          <a href="#" class="text-decoration-none d-block px-3 py-2"><i class="fa-solid fa-users me-3"></i>Visitor
            Information</a>
        </li>
        <li class="mb-3">
    ...
    <div class="content">
      <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
          <span class="navbrand navbar-brand mb-0 fs-5">Visitor Information</span>
        </div>
      </nav>
    </div>
  </div>
